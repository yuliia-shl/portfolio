        ...
        <div className="w-full">
          ...
          <div className="flex gap-5">
            ...
            <a
              ...
              target="_blank"
              className="flex p-3 lg:p-3.5 bg-shark-950 items-center rounded-full transition-transform duration-300 hover:scale-115"
            >
              <svg className="w-6 h-6 lg:w-6.5 lg:h-6.5 fill-yellow-green-300 hover:fill-conifer-400 transition duration-300">
